...
## Detail Requirements
Shooting / Player Damage, Death/ Enemy Destruction / Background music & Event music (level complete/ lose game), LevelUp, Pick Items, Boost, Intensive Phase

## Dependencies on other names
VisualEffectSystem  
LevelDesignSystem  
Gameplay HUD  
